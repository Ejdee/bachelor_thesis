...
Year:        2026
Description: Aggregates reprojection-error threshold curves.
============================================================================="""
...
def aggregate_re_threshold_curves(numbers, thresholds, recon_root):
    """Compute per-model RE threshold curves averaged across multiple reconstructions.

    Returns a dict mapping model name to {mean, std, num_runs} arrays over thresholds,
    where each value is the count of 3D points with reprojection error <= threshold.
    """
    per_model_curves = {}
